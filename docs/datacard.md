...
- The dataset [telco_customer_churn.csv](data/telco_customer_churn.csv) has information about how company churns its customers depending on various factors.
